      ...
      <tr>
         <td style="background: #FFF;padding: 5px 5px 5px 5px;" valign="top">
            ...
            <div class="box-content">
               ...
               <form action="<?php echo base_url();?>admin/contactadmin/deletes" method="post" accept-charset="utf-8" id="admindata_kh">
                     ...
                     <thead>
                        <tr>
                           <th class="head" colspan="7">
                              <a class="del" onclick="return action_del('admindata_kh','contact');"><span>Xóa</span></a>                                Có <?php echo count($list_contact)?> liên hệ <span class="pages"><span class="pagebar-mainbody">
                           <?php 

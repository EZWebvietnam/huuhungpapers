 ...
 */
 if($_SERVER['SERVER_NAME'] == 'localhost')
 {
     ...
     define('DB_USER','root');
     define('DB_PASS','');
     define('ROT_DIR','/huuhungpapers/');
     define('BASE_URL','http://localhost/huuhungpapers/');
     define('MAIL_ADMIN','no-reply@vietmongco.vn');
 ...
 else
 {
    ...
    define('MAIL_ADMIN','no-reply@vietmongco.vn');
        define('PATH_FOLDER','/export/linux/www/net/m/a/nhucauvieclam/2/5/giangbeo.H1325/huuhungpapers.com');
 }

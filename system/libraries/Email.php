...
class CI_Email {
	...
	var	$smtp_host		= "mail.ninhbinhcoop.com";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "no-reply@ninhbinhcoop.com";		// SMTP Username
	var	$smtp_pass		= "no-reply";		// SMTP Password
